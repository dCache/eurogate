//
// class definition for Volume record within Berkeley DB  DESY -mg
//
...
public class bdbVolume implements java.io.Serializable {
  ...
  private void readObject(ObjectInputStream s) throws IOException {
    ...
    _files        = s.readLong();
    _bfids = new Vector((int) _files + 2);
  ...
  public void addBfid(bdbBfid bf) {
    if (bf._volume.compareTo(_name) != 0) {
      throw new IllegalArgumentException("volume bfid corruption");
    }
    if (_bfids == null)
      _bfids = new Vector();

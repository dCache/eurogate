// test app for the EuroStore Berkeley/DB Store
...
public class bdbTest implements Logable {

  private BerkDBStore _os = null;
  private BitfileRequest _bfr = null;
  private RequestImpl _r = null;
  private StorageSessionable _ses[] = null;
  public boolean _long = true;
  
  public bdbTest() {
    Args arg = new Args("-dbpath=/export/home/martin/es-work/eurogate/store/bdb");
    try {
      _os = new BerkDBStore(arg, null, this);
